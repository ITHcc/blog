  ...
  <body class="layui-anim layui-anim-up">
    ...
    <div class="x-body">
      ...
      <xblock>
        ...
        <button class="layui-btn" onclick='x_admin_show("添加标签","{{ route('category.create') }}",450,200)'><i class="layui-icon"></i>添加</button>
        ...
        <tbody>
          @foreach ($data as $v)
            <tr>
              ...
              <td>{{$v['created_at']}}</td>
              <td class="td-manage">
                <a title="编辑"  onclick='x_admin_show("编辑","{{ route('category.edit',['id'=>$v['id']]) }}",450,200)' href="javascript:;">
    ...
    <script>
      ...
      function member_del(obj,id){
          layer.confirm('确认要删除吗？',function(index){
              ...
              let url = "{{  route('category.destroy',['id'=>777])  }}";
