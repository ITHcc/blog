  ...
  <body class="layui-anim layui-anim-up">
    ...
    <div class="x-body">
      ...
      <xblock>
        ...
        <button class="layui-btn" onclick='x_admin_show("添加banner","{{ route('banner.create') }}",1100,700)'><i class="layui-icon"></i>添加</button>
          ...
          @foreach ($data as $v)
            <tr>
              ...
              <td class="td-manage">
                ...
                @endif
                <a title="编辑"  onclick='x_admin_show("编辑","{{ route('banner.edit',['id'=>$v['id']]) }}",1100,700)' href="javascript:;">
                  <i class="layui-icon">&#xe642;</i>
                </a>
    ...
    <script>
      ...
      function member_stop(obj,id){
          layer.confirm('确认要修改吗？',function(index){
              ...
              let larvelUrl = "{{  route('banner.status',['id'=>777])  }}";
      ...
      function member_del(obj,id){
          layer.confirm('确认要删除吗？',function(index){
              ...
              let url = "{{  route('banner.destroy',['id'=>777])  }}";
