  ...
  <body class="layui-anim layui-anim-up">
    ...
    <div class="x-body">
      ...
      <xblock>
        ...
        <button class="layui-btn" onclick='x_admin_show("添加推荐","{{ route('recommend.create') }}",1100,700)'><i class="layui-icon"></i>添加</button>
          ...
          @foreach ($data as $v)
            <tr>
              ...
              <td class="td-manage">
                ...
                @endif
                <a title="编辑"  onclick='x_admin_show("编辑","{{ route('recommend.edit',['id'=>$v['id']]) }}",1100,700)' href="javascript:;">
                  <i class="layui-icon">&#xe642;</i>
                </a>
    ...
    <script>
      ...
      function member_del(obj,id){
          layer.confirm('确认要删除吗？',function(index){
              ...
              let url = "{{  route('recommend.destroy',['id'=>777])  }}";
